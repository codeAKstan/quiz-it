            ...
            >
                <div className="absolute inset-x-0 top-[-50px] flex justify-center">
                    <div className="relative cursor-pointer" onClick={handleImageClick}>
                        <img
                            src={previewImage || getImageUrl(user.profile_image) || '/profile.svg'}
                            alt={`${user.username}'s profile`}
                            className="w-28 h-28 rounded-full border-2 border-[#ffffff] object-cover"
                        />
                        <div className="absolute bottom-0 right-0 bg-[#46178F] rounded-full p-1">
                            <img
                                src="/add.svg"
                                alt="Edit"
                                className="w-4 h-4"
                ...
                {uploadingImage && (
                    <div className="absolute inset-x-0 top-[-30px] flex justify-center">
                        <p className="text-white bg-[#46178F] px-2 py-1 rounded text-xs">Uploading...</p>
                    </div>
                )}
